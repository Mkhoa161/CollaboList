    ...
    <Container>
        <SectionComponent styles={{
            ...
            <ButtonComponent 
                isLoading={isLoading}
                title='Sign up' 
                onPress={handleSignUpWithEmail} color={colors.blue} styles={{padding: 8, borderRadius: 14}}/>
            
            <SpaceComponent height={20}/>
            <Text style={[globalStyles.text, {textAlign: 'center'}]}>
                You already have an account? {' '} <Text style={{color: 'coral'}} onPress={() => navigation.navigate('LoginScreen')}>Login</Text>
            </Text>
        </SectionComponent>
    </Container>
  )
